"""
Django settings for boosty_project project.
"""
...
ALLOWED_HOSTS = config('DJANGO_ALLOWED_HOSTS', default='localhost 127.0.0.1 [::1] backend frontend').split()
...
ROOT_URLCONF = 'boosty_project.urls'
...
WSGI_APPLICATION = 'boosty_project.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('POSTGRES_DB', default='boosty_db'),
        'USER': config('POSTGRES_USER', default='boosty_user'),
        'PASSWORD': config('POSTGRES_PASSWORD', default='boosty_password'),
